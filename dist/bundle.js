...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var uuid__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! uuid */ \"./node_modules/uuid/dist/esm-browser/v4.js\");\n/* harmony import */ var _index__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index */ \"./src/cart/index.ts\");\n\n\nclass Shop {\n    constructor(_shopName, _parent, _id = (0,uuid__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(), _products = []) {\n        this._shopName = _shopName;\n        this._parent = _parent;\n        this._id = _id;\n        this._products = _products;\n        this.showItems = () => {\n            const div = document.createElement('div');\n            for (let productItem of this.products) {\n                div.append(productItem.itemElement(productItem));\n            }\n            const productsContainerStyle = {\n                width: \"50%\",\n            };\n            Object.assign(div.style, productsContainerStyle);\n            return div;\n        };\n        /* @ts-ignore */\n        this.updateCart = () => {\n            if (Shop.myUser) {\n                const div = document.createElement('div');\n                div.id = \"cartDivElement\";\n                if (Shop.myUser.cart.length > 0) {\n                    div.appendChild(Shop.myUser.cartHTMLElement());\n                }\n                else {\n                    const noItems = document.createElement('p');\n                    noItems.innerText = \"Cart is empty.\";\n                    div.appendChild(noItems);\n                }\n                const cartContainerStyle = {\n                    width: \"50%\"\n                };\n                Object.assign(div.style, cartContainerStyle);\n                return div;\n            }\n        };\n        this.addDefaultItems = () => {\n            this._products.push(new _index__WEBPACK_IMPORTED_MODULE_0__.Item(\"Monstera Deliciosa\", 200, \"Swiss Cheese Leaves, Indirect sunlight\"));\n            this._products.push(new _index__WEBPACK_IMPORTED_MODULE_0__.Item(\"Pothos\", 55, \"Trailing heart shape leaves, Indirect sunlight\"));\n            this._products.push(new _index__WEBPACK_IMPORTED_MODULE_0__.Item(\"Money Tree\", 100, \"Braided trunk, Low light, Indirect sunlight\"));\n            this._products.push(new _index__WEBPACK_IMPORTED_MODULE_0__.Item(\"Bunny Ear Cactus\", 35, \"Slow-growing desert plant, Direct Sunlight\"));\n            this._products.push(new _index__WEBPACK_IMPORTED_MODULE_0__.Item(\"Palm Tree\", 85, \"Indoor Palm, Indirect sunlight\"));\n            this._products.push(new _index__WEBPACK_IMPORTED_MODULE_0__.Item(\"Peace Lilies\", 55, \"Brilliant white flowers, full sunlight\"));\n            this._products.push(new _index__WEBPACK_IMPORTED_MODULE_0__.Item(\"Fiddle Leaf Fig\", 150, \"Tall, dramatic plant, Sensitive plant\"));\n            this._products.push(new _index__WEBPACK_IMPORTED_MODULE_0__.Item(\"Snake\", 50, \"Sword-like leaves, Indirect sunlight\"));\n            this._products.push(new _index__WEBPACK_IMPORTED_MODULE_0__.Item(\"Cereis Cactis\", 35, \"Flowering Cactus, Direct sunlight\"));\n        };\n        this.addDefaultItems();\n        this.parent.innerHTML = \"\";\n        this.parent.id = \"shopContainer\";\n        const shopContainerStyle = {\n            margin: \"40px auto\",\n            width: \"60%\",\n            minWidth: \"700px\",\n            display: \"flex\",\n            flexDirection: \"row\",\n        };\n        Object.assign(this.parent.style, shopContainerStyle);\n        this.parent.append(this.showItems(), this.updateCart());\n    }\n    get products() {\n        return this._products;\n    }\n    set products(value) {\n        this._products = value;\n    }\n    get id() {\n        return this._id;\n    }\n    set id(value) {\n        this._id = value;\n    }\n    get parent() {\n        return this._parent;\n    }\n    set parent(value) {\n        this._parent = value;\n    }\n    get shopName() {\n        return this._shopName;\n    }\n    set shopName(value) {\n        this._shopName = value;\n    }\n}\n// Static Methods\n/*  @ts-ignore */\nShop.loginUser = (e) => {\n    e.preventDefault();\n    const userInput = document.getElementById('userInput');\n    const emailInput = document.getElementById('emailInput');\n    const cartContainer = document.getElementById('cartContainer');\n    const loginForm = document.getElementById('loginForm');\n    const loginText = document.getElementById('loginText');\n    const disappear = { display: 'none' };\n    Object.assign(loginForm.style, disappear);\n    loginText.innerText = `Welcome, ${userInput.value}! Happy Plant Shopping!`;\n    Shop.myUser = _index__WEBPACK_IMPORTED_MODULE_0__.User.loginInUser(userInput.value, emailInput.value);\n    Shop.currentCart = new Shop(\"Greenery\", cartContainer);\n};\nShop.refreshCart = () => {\n    const cartDivElement = document.getElementById('cartDivElement');\n    if (cartDivElement) {\n        cartDivElement.replaceChildren(Shop.currentCart.updateCart());\n    }\n};\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Shop);\n\n\n//# sourceURL=webpack://tspp_oopcart/./src/cart/Shop.ts?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _cart_Shop__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./cart/Shop */ \"./src/cart/Shop.ts\");\n// import { Shop } from \"./cart/index\";\n\nconst loginForm = document.getElementById('loginForm');\nloginForm.addEventListener(\"submit\", _cart_Shop__WEBPACK_IMPORTED_MODULE_0__[\"default\"].loginUser);\n\n\n//# sourceURL=webpack://tspp_oopcart/./src/index.ts?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nconst randomUUID = typeof crypto !== 'undefined' && crypto.randomUUID && crypto.randomUUID.bind(crypto);\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({\n  randomUUID\n});\n\n//# sourceURL=webpack://tspp_oopcart/./node_modules/uuid/dist/esm-browser/native.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (/^(?:[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}|00000000-0000-0000-0000-000000000000)$/i);\n\n//# sourceURL=webpack://tspp_oopcart/./node_modules/uuid/dist/esm-browser/regex.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _regex_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./regex.js */ \"./node_modules/uuid/dist/esm-browser/regex.js\");\n\n\nfunction validate(uuid) {\n  return typeof uuid === 'string' && _regex_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].test(uuid);\n}\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (validate);\n\n//# sourceURL=webpack://tspp_oopcart/./node_modules/uuid/dist/esm-browser/validate.js?");
